...
def build_train_test_resnet_report(
    *,
    model,
    n_params,
    epochs,
    ...
    """Build the persisted FP32 training report payload for test_resnet."""
...
def build_qat_test_resnet_report(
    *,
    weight_bits,
    act_bits,
    n_params,
    ...
    """Build the persisted KD-QAT training report payload for test_resnet."""
