...
Loads the QAT checkpoint saved by qat_mobilenetv1.py and exports to QONNX.
...
Run with:
    python src/export_mobilenetv1.py
"""
...
def main(cfg: DictConfig) -> None:
    ...
    if not os.path.exists(ckpt_path):
        ...
        print("Run qat_mobilenetv1.py first.")
        return
    ...
    print(
        f"Next: python src/finn_build/build_mobilenetv1.py "
        f"--estimates-only --onnx models/mobilenet_{tag}.onnx"
    )
