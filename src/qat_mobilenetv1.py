...
def main(cfg: DictConfig) -> None:
    ...
    logname = os.path.join(cfg.results_dir, "qat_mobilenetv1_log.csv")
    ...
    report_path = os.path.join(cfg.results_dir, "qat_mobilenetv1_report.json")
    with open(report_path, "w") as f:
        json.dump(report, f, indent=2)
    print(f"\nReport saved -> {report_path}")
    print("\nNext step: run export_mobilenetv1.py to export QONNX.")
