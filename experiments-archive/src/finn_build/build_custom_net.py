"""
FINN Dataflow Build for QAT CustomSmallNet -> Kria KV260 bitstream.

Defaults to the revived custom-net accuracy branch (`8w8a`), while still
allowing explicit `--onnx` overrides such as `custom_net_m3_6w6a`.
...
parser = argparse.ArgumentParser(
    description="FINN dataflow build for QAT CustomSmallNet -> Kria KV260."
)
parser.add_argument("--onnx", default="models/custom_net_m3_8w8a.onnx")
parser.add_argument("--output-dir", default="./build_finn_custom_net_kv260")
...
print(f"\n{'=' * 60}")
print("  FINN Dataflow Build - CustomSmallNet")
print(f"{'=' * 60}")
...
if args.folding_config:
    ...
    print("  Folding: auto (target_fps_parallelization)")
